...
if (window.require) {
  ...
  require.config({
    paths: {
      "highlight": "flowchart-diagram/assets/js/highlight",
      "jquery": "flowchart-diagram/assets/js/jquery.min", // 1.11.3
      "bootstrap": "flowchart-diagram/assets/js/bootstrap.min"
    },
    shim: {
      "bootstrap": ["jquery"]
    }
